...
def eval_result_payload(result: EvalResult) -> EvalReport:
    ...
    payload: EvalReport = {
        ...
        "duplicate_result_rate": finite_metric_value(
            result.duplicate_result_rate,
            name="duplicate_result_rate",
        ),
        "unique_document_count": result.unique_document_count,
        "off_topic_result_rate": finite_metric_value(
            result.off_topic_result_rate,
            name="off_topic_result_rate",
        ),
...
def _aggregate_metrics(
    ...
    *,
    ...
    metrics: EvalReport = {
        ...
        "duplicate_result_rate": _mean_payload_value(
            payloads,
            "duplicate_result_rate",
        ),
        "unique_document_count": _mean_payload_value(
            payloads,
            "unique_document_count",
        ),
        "off_topic_result_rate": _mean_payload_value(
            payloads,
            "off_topic_result_rate",
        ),
        "suppressed_duplicate_count": _sum_payload_int(
            payloads,
