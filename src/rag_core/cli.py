...
from rag_core.cli_ingest import run_detected_ingest_command
...
from rag_core.cli_manifest import run_manifest_command
...
async def _run_command(
    ...
    try:
        ...
        if args.command == "mcp":
            return await run_mcp_command(args, core_factory=RAGCore)
