...
async def _embedding_provider_health(config: RAGCoreConfig) -> ProviderHealth | None:
...
async def _reranker_provider_health(config: RAGCoreConfig) -> ProviderHealth | None:
    try:
