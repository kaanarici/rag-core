...
class SupportsContextPromptPayload(Protocol):
    def as_prompt_text(self, *, context_order: ContextOrder = "rank") -> str: ...

    def to_prompt_payload(self) -> dict[str, object]: ...


SupportsContextPackPromptPayload = SupportsContextPromptPayload
...
def search_user_documents_tool_result(
    ...
    *,
    ...
    """Return the canonical JSON tool output for a ``Context``."""
    payload = {
