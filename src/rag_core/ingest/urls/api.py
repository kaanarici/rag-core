...
from rag_core.ingest.urls.runner import (
    RemoteUrlIngestAborted,
    RemoteUrlIngestCore,
    RemoteUrlIngestCoreFactory,
    ingest_remote_urls as _ingest_remote_urls,
)
from rag_core.ingest.urls.records import remote_ingest_error_type
from rag_core.ingest.urls.sources import (
    ...
    *,
    ...
    try:
        ...
        if close_core and core is not None:
            await lifecycle.close_owned_core(
                core.close,
