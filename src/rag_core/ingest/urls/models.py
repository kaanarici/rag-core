...
class RemoteUrlIngestRequest:
    ...
    """When set, every URL host must be authorized for ``collection``.

    Applications can wire this for licensed corpora so a URL outside the
    procurement-bound host set is rejected before any fetch happens.
    """
