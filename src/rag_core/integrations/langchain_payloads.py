        ...
        _compact(
            {
                ...
                "rag_core_collection": result.collection,
...
def context_pack_to_tool_output(
    ...
    *,
    ...
    return (
        pack.as_prompt_text(context_order=context_order),
        search_user_documents_tool_result(pack, context_order=context_order),
    )
