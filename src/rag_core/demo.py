    ...
    return RAGCore(
        RAGCoreConfig(
            qdrant=QdrantConfig(
                ...
                collection=f"{_DEMO_COLLECTION_PREFIX}_{collection}",
...
async def ingest_demo_billing_document(core: RAGCore) -> IngestedDocument:
