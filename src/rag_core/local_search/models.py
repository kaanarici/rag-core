...
class LocalSearchResult:
    ...
    def to_payload(self) -> dict[str, object]:
        return {
            ...
            "indexed": [_public_indexed_payload(item) for item in self.indexed],
...
def _public_indexed_payload(payload: dict[str, object]) -> dict[str, object]:
    public = dict(payload)
    processing_version = public.pop("processing_version", None)
    if processing_version is not None:
        public["pipeline_version"] = processing_version
    return public
