...
from ..pdf_page_locators import normalize_pdf_page_body
...
def pymupdf_conversion_result(
    ...
    *,
    ...
    for page in extraction.pages:
        if page.text:
            markdown = normalize_pdf_page_body(text_to_markdown(page.text))
    ...
    garbled_page_indices = [
        page.page_num
        for page in extraction.pages
        if getattr(page, "has_garbled_text", False)
    ]
