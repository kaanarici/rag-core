...
# ``{"path", "namespace", "collection"}`` (the file content stays on disk and
...
# Process-wide ingest semaphore. Caps concurrent ingest requests so a bursty
# caller cannot exhaust file descriptors / embedder budget. 503 with
