...
_EVENT_SINK_RUNTIME_CONFIG = {
    LoggingSink.provider_name: "RAGCore(..., event_sink=LoggingSink(...))",
    JsonlSink.provider_name: "RAGCore(..., event_sink=JsonlSink(...))",
    EventBuffer.provider_name: "RAGCore(..., event_sink=EventBuffer())",
    MultiSink.provider_name: "RAGCore(..., event_sink=MultiSink(...))",
}
    ...
    *,
    ...
    providers: dict[str, object] = {
        DEFAULT_EVENT_SINK_PROVIDER: {
            ...
            FIELD_RUNTIME_CONFIG: "RAGCore(..., event_sink=None)",
        },
        ...
        OpenTelemetrySink.provider_name: {
            ...
            FIELD_RUNTIME_CONFIG: "RAGCore(..., event_sink=OpenTelemetrySink())",
        },
    }
    add_injected_provider(
        providers,
