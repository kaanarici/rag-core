...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "format_evidence": ("rag_core.search.context_pack", "format_evidence"),
    ...
    "SearchOptions": ("rag_core.search.request_models", "SearchOptions"),
    "SEARCH_PROFILES": ("rag_core.search.planning", "SEARCH_PROFILES"),
    "SearchResult": ("rag_core.search.vector_models", "SearchResult"),
    "Evidence": ("rag_core.search.vector_models", "Evidence"),
    "RetrievalResult": ("rag_core.search.vector_models", "RetrievalResult"),
    "Answerability": ("rag_core.search.vector_models", "Answerability"),
