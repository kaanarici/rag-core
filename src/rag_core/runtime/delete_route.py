...
async def handle_delete_document(
    ...
    *,
    ...
    """Drive the DELETE route end-to-end against a resolved RAGCore.
    ...
    try:
        result = await core.delete_document(
            ...
            corpus_id=delete_request.corpus_id,
        )
    except ValueError as exc:
        # ``CorpusPolicyViolation`` is a ``ValueError`` subclass; the engine
        ...
        return api_error(
            ...
            message="delete refused by corpus policy",
            status_code=400,
