...
def add_local_eval_command(
    ...
    local_eval.add_argument(
        ...
        type=float,
        default=None,
        help="Optional quality gate minimum for aggregate recall_at_5.",
    )
    local_eval.add_argument(
        "--min-mrr",
        type=float,
        default=None,
        help="Optional quality gate minimum for aggregate MRR.",
    )
    local_eval.add_argument(
        "--max-latency-p95-ms",
        type=float,
        default=None,
        help="Optional quality gate maximum for aggregate p95 latency.",
    )
