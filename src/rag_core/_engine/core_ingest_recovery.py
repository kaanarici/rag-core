...
from rag_core.manifest.persistence import delete_entry, read_entries, write_entry
from rag_core.ingest.urls.document_keys import public_remote_document_key
...
async def restore_manifest_from_vector_store(
    *,
    ...
    mime_type: str,
    document_key: str,
    fallback_entry: CollectionManifestEntry | None,
) -> None:
...
def latest_manifest_entry(
    ...
    *,
    ...
    collection: str,
    document_id: str,
) -> CollectionManifestEntry | None:
    for entry in read_entries(directory, namespace=namespace, collection=collection):
...
def restored_manifest_entry_from_existing_record(
    record: StoredDocumentRecord,
    *,
    previous: CollectionManifestEntry | None,
    filename: str,
    mime_type: str,
    document_key: str | None = None,
) -> CollectionManifestEntry:
