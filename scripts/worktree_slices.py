...
SLICE_DEFINITIONS: tuple[SliceDefinition, ...] = (
    ...
    SliceDefinition(
        ...
        prefixes=(
            ...
            "src/rag_core/ingest/sources/archive.py",
            "src/rag_core/ingest/sources/local.py",
            "src/rag_core/manifest/reconciliation/__init__.py",
            "src/rag_core/quickstart.py",
            "src/rag_core/ingest/urls/document_keys.py",
            "src/rag_core/ingest/sources/remote.py",
        ),
    ),
    SliceDefinition(
        key="core-ingest-manifest",
        title="Core Ingest And Manifest",
        purpose="Engine ingest, source identity, lifecycle, manifests, and reconciliation.",
        validation=(
    ...
    SliceDefinition(
        ...
        purpose="Optional HTTP runtime that stays thin over Engine.",
        validation=(
