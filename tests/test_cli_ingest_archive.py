...
from rag_core.core_models import CorpusManifestEntry, RAGCoreConfig
from rag_core.local_ingest_models import LocalIngestResult, LocalIngestSuccess
...
class _FakeRAGCore:
    ...
    async def ingest_archive(self, archive_path: str, **kwargs: Any) -> LocalIngestResult:
...
def test_ingest_archive_lazy_provider_bootstrap_error_is_actionable(
    ...
    class _ProviderFailingCore:
        ...
        async def ingest_archive(self, *_args: Any, **_kwargs: Any) -> None:
