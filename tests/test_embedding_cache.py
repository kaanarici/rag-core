...
def test_sqlite_cache_unbounded_get_put_skip_eviction(
    ...
    monkeypatch.setattr(
        "rag_core.search.providers.embedding_sqlite_cache.evict_sqlite_cache_rows",
        _fail_eviction,
    )
    monkeypatch.setattr(
        "rag_core.search.providers.embedding_cache.evict_sqlite_cache_rows",
        _fail_eviction,
    )
...
def test_sqlite_cache_max_entries_trims_oldest_write_timestamp(
    ...
    monkeypatch.setattr(
        "rag_core.search.providers.embedding_sqlite_cache.time.time",
