...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            [
                {"point_id": "p1", "namespace": "team-a", "corpus_id": "corpus-1"},
                {"point_id": "p2", "namespace": "team-b", "corpus_id": "corpus-1"},
                {"point_id": "p3", "namespace": "team-a", "corpus_id": "corpus-2"},
            ],
            {"namespace": "team-a", "corpus_ids": ["corpus-1"]},
            ["p1"],
        ),
        (
            "document_ids",
