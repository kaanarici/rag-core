...
def test_lexical_opt_in_merges_sidecar_and_vector_results() -> None:
    async def _run() -> None:
...
def test_cancelled_search_cancels_sibling_embedding_task() -> None:
    ...
    async def _run() -> None:
        ...
        query = PipelineQuery(
            ...
            namespace="n",
            collections=["c"],
            query_plan=query_plan_preset("hybrid_rrf", limit=10),
        )
