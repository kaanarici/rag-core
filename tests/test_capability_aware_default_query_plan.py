...
from rag_core.search.types import QueryPlanCapabilities, SearchQuery, StoreCapabilities
...
def test_default_query_plan_prefers_documented_balanced_profile_before_weighted_rrf() -> None:
    plan = default_query_plan_for_capabilities(
        capabilities=QueryPlanCapabilities(
            dense=True,
            sparse=True,
...
def test_implicit_default_plan_downgrades_when_sparse_query_channel_is_missing() -> None:
    embedding = FakeEmbeddingProvider()
