...
def test_default_query_plan_prefers_dense_when_hybrid_is_declared() -> None:
...
def test_default_query_plan_uses_dense_when_turbopuffer_declares_hybrid() -> None:
    plan = default_query_plan_for_capabilities(
...
def test_default_query_plan_uses_dense_when_weighted_rrf_is_available() -> None:
    plan = default_query_plan_for_capabilities(
...
def test_default_query_plan_remains_dense_when_multiple_hybrid_modes_are_available() -> (
    None
):
    plan = default_query_plan_for_capabilities(
        capabilities=QueryPlanCapabilities(
