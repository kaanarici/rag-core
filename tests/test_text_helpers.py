...
@pytest.mark.parametrize(
    ...
    [
        ...
        " ## Existing level two",
        "  ###\tPage 99 ###",
        "   ####\N{NO-BREAK SPACE}Existing level four",
        "##### Existing level five",
        "###### Existing level six",
        "## C#",
        "    ## Page 99",
...
def test_text_to_markdown_preserves_atx_and_four_space_code(
    source_line: str,
) -> None:
    assert text_to_markdown(f"{source_line}\nbody").splitlines()[0] == source_line
