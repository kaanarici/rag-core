...
def test_direct_qdrant_default_plan_uses_dense_profile_when_sparse_is_available() -> None:
    query = _make_query(query_plan=None, limit=5)
    ...
    assert plan.search_profile == "fast"
    assert [
...
def test_adapter_default_query_plan_prefers_dense_when_sparse_channels_exist() -> None:
