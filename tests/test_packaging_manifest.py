...
def test_public_checkout_smoke_is_required_sdist_artifact() -> None:
    assert "scripts/public_checkout_smoke.sh" in REQUIRED_SDIST_SUFFIXES


def test_github_install_smoke_is_required_sdist_artifact() -> None:
    assert "scripts/github_install_smoke.sh" in REQUIRED_SDIST_SUFFIXES


def test_release_docs_are_required_sdist_artifacts() -> None:
    assert "docs/release.md" in REQUIRED_SDIST_SUFFIXES
    assert "docs/self-host/openapi.yaml" in REQUIRED_SDIST_SUFFIXES
