...
the next ``ingest_bytes`` on the same ``(namespace, corpus_id, document_id)``
...
class _RecordingSidecar:
    ...
    def delete_document(
        ...
        *,
        ...
        self.deleted.append((namespace, document_id, str(corpus_id)))
        if self.fail:
...
class _RecordingCache:
    ...
    async def delete_by_document_scope(
        ...
        *,
        ...
        self.calls.append((namespace, corpus_id, document_id))
        if self.fail:
