...
def test_search_command_rejects_old_context_json_flag() -> None:
    parser = _build_parser()
...
def test_search_context_defaults_to_context_payload() -> None:
    parser = _build_parser()
    args = parser.parse_args(
        [
            "context",
    ...
    assert args.context_order == "rank"


def test_search_context_accepts_context_order_flag() -> None:
    parser = _build_parser()
    args = parser.parse_args(
        [
            "context",
    ...
    assert args.command == "context"
    assert args.context is True
    assert args.context_order == "extrema"


def test_search_context_rejects_unknown_context_order() -> None:
    parser = _build_parser()
