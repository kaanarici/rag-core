...
def test_classify_paths_into_reviewable_landing_slices() -> None:
    ...
    assert classify_path("src/rag_core/local_eval_runner.py") == "public-api-cli-config"
    assert classify_path("src/rag_core/local_search_runner.py") == "public-api-cli-config"
