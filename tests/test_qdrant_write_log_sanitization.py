...
from rag_core.search.providers import qdrant_write_retry
from rag_core.search.providers.qdrant_shared import WriteLatencyTracker
from rag_core.search.providers.qdrant_write_retry import (
    log_upsert_error,
...
def test_slow_qdrant_write_log_omits_collection_name(
    ...
    async def run() -> None:
        ...
        monkeypatch.setattr(
            qdrant_write_retry, "_SLOW_WRITE_THRESHOLD_SECONDS", -1.0
        )
